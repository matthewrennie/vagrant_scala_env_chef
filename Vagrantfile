...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Ensure we have the latest version of chef
  ...
  config.vm.provision "chef_solo" do |chef|   
    ...
    chef.json = {
     ...
     "artifactory" => {
        ...
        "protocol" => "https",
        "domain" => "<ci.foobar.com>",
        "path" => "/artifactory/repo/",
        "username" => "<username>",
        "password" => "<password>",
        "repo_name" => "Foobar Repo"
      },

      "source_repo" => {
        "domain" => "bitbucket.org",        
        "clone_url" => "git@bitbucket.org:<company>/<repository>.git",
        "branch" => "master",
      ...
      "sbt" => {
        "version" => "0.13.5",
        "java_options" => "-Xmx1024m -Xms512m -XX:MaxPermSize=256m"
      },
